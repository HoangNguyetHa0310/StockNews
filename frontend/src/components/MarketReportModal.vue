<template>
  ...
  >
    <div 
      class="bg-theme-card border border-theme-border rounded-2xl sm:rounded-3xl w-full max-w-6xl max-h-[calc(100dvh-5rem)] sm:max-h-[90vh] flex flex-col shadow-2xl overflow-hidden transition-colors duration-200 my-auto text-theme-text"
    >
      <!-- Modal Header -->
      ...
      <!-- Modal Footer -->
      <div class="px-4 sm:px-6 py-3 border-t border-theme-border bg-theme-subtle flex flex-col sm:flex-row items-center justify-between gap-3 text-xs text-theme-text-muted">
